      ...
      <section className='relative bg-white py-32 lg:py-36 dark:bg-black'>
        <div className='mx-auto flex w-full flex-col gap-10 px-5 sm:px-10 md:px-12 lg:max-w-7xl lg:flex-row lg:gap-12 lg:px-5'>
          ...
          <div className='relative mx-auto flex max-w-3xl flex-col items-center text-center lg:mx-0 lg:w-1/2 lg:max-w-none lg:flex-1 lg:items-start lg:py-7 lg:text-left xl:py-8'>
            ...
            <h1 className='text-3xl font-bold leading-tight dark:text-gray-400 text-gray-900 sm:text-4xl md:text-5xl xl:text-6xl'>
            ...
            <p className='mt-6 text-gray-700 dark:text-gray-500'>
              A super tool for on-the-spot feedback, online polls let you check
              in with your audience or customers at any time. When you do, you
              send the message that you know they’re there and their opinions
              matter. And with instant access to poll results, you can get
              understanding of the people you’re trying to reach and take action
              based on their opinions, preferences.
            </p>
            <div className='mx-auto mt-5 flex  max-w-md lg:mx-0 w-full'>
              <div className='flex w-full flex-col gap-5 sm:flex-row justify-center'>
